...
{
    BorderControl.m_N = 0;
    if(0 != m_curr_prop[i-1][j].type && i-1 >= 0)  BorderControl.m_N++;
    if(0 != m_curr_prop[i+1][j].type && i+1 < MAX) BorderControl.m_N++;
    if(0 != m_curr_prop[i][j-1].type && j-1 >= 0)  BorderControl.m_N++;
    if(0 != m_curr_prop[i][j+1].type && j+1 < MAX) BorderControl.m_N++;
