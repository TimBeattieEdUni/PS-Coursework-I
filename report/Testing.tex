...
%Documentation for \texttt{Unittest++} can be found either on the \texttt{Unittest++} home page or in the following file in the project (once the project has been built):
%\texttt{Unittest++}/docs/\texttt{Unittest++}.html

\texttt{Unittest++} was downloaded as a .zip file and added to the project's Git repository in the "downloads" directory.
