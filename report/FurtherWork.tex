...
While we have written a function called \texttt{ApplyPopulation} within the \testtt{/Landscape} class that would allow the passing of a tailored array of pumas and hares to the class however we ran out of time to implement this as an option within the program. 
